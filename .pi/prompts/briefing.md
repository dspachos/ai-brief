...
- Emphasize the crux with `<strong>` — key numbers, names, and decisive phrases. At most ~3 per paragraph, never a whole sentence, and never inside the markets table.
